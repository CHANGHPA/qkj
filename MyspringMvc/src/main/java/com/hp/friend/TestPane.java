...
public class TestPane extends JPanel {
	private static final long serialVersionUID = 1L;  
	 ...
	 final JLabel []jb=new JLabel[7];  
	  jb[0] = new JLabel();  
	  jb[0].setText("黑名单");  
	  jb[0].setIcon(new ImageIcon("stract/img/333.png"));  
