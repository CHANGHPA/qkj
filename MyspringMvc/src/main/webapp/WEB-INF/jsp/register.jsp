...
<head>
<title>注册-个人用户</title>
<link type="text/css" rel="stylesheet" href="stract/css/login.css" />
<link type="text/css" rel="stylesheet" href="stract/css/regist.personal.css" />
<link type="text/css" rel="stylesheet" href="stract/css/passport.base.css" />
...
<body>
	<div class="w" id="regist">
		<div class="mt">
			...
			<div class="extra">
				<span>我已经注册，现在就&nbsp; <a
					href="<%=request.getContextPath()%>/login" class="flk13">登录</a>
				</span>
			</div>
		</div>
		<div class="mc">
			<form method="post"  class="form-actions"
				action="<%=request.getContextPath()%>/registervalid" onsubmit="return CheckForm();">
				<div class="form">
					<div class="item">
