...
<body>
	...
	<form method="post" action="<%=request.getContextPath() %>/login" class="form-actions">
		<div class=" w1" id="entry">
			<div class="mc " id="bgDiv">
			<div id="logo">
			 <img src="stract/img/logo.jpg" alt="空间" width="470" height="360" />
	    	</div>
				<div class="form ">
			...
			<div class="free-regist">
				<span><a href="<%=request.getContextPath()%>/register" >免费注册&gt;&gt;</a></span>
			</div>
		</div>
	</form>
